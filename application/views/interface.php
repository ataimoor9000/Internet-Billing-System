                    ...
                    <tbody>
                        <?php $i = 0; foreach ($users as $row) { $i++; ?>
                            ...
                            <tr class="even pointer">
                                ...
                                <tr class="even pointer">
                                <td class=" "><?php echo $i; ?></td>
                                <?php if($row->photo_cnic){?>
                                    <td class=" "><img class="cnicImage" src="<?php echo base_url() . "assets/images/final/" . $row->photo_cnic; ?>" alt="Photo"></td>
                                <?php } else{ ?>
                                    <td class=" "><img class="cnicImage" src="<?php echo base_url()?>assets/images/user.png" alt="cnicImage"></td>
                                <?php } ?>  
